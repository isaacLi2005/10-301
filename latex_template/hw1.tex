...
\newcommand{\outDate}{Monday, January 12th}
\newcommand{\dueDate}{Wednesday, January 21st}
\newcommand{\taNames}{Alan, Changwook, Doris, Soham, Zachary, Neural the Narwhal}
...
def fib_2(n):
    ...
    \subpart[1] What is the node-visit order of \textbf{DFS} of the above Binary Tree? 
